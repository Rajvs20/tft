...
def process_favorita(config):
  ...
  # load temporal data
  temporal = pd.read_csv(os.path.join(data_folder, 'train.csv'), parse_dates=['date'])

  items = pd.read_csv(os.path.join(data_folder, 'items.csv'))
  holidays = pd.read_csv(os.path.join(data_folder, 'holidays_events.csv'))
  store_info = pd.read_csv(os.path.join(data_folder, 'stores.csv'))
  ...
  temporal = temporal.join(store_info.set_index("store_nbr"), on='store_nbr', how='left')

  print('Adding item info')
  temporal = temporal.join(items.set_index("item_nbr"), on='item_nbr', how='left')
